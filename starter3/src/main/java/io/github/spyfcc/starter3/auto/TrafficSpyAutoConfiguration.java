...
import io.github.spyfcc.starter3.config.SpySearchConfig;
...
@Import({ SpyWebConfig.class, SpySearchConfig.class, io.github.spyfcc.starter3.controller.SpyUIScreenController.class,
...
public class TrafficSpyAutoConfiguration {
	...
	public ExecutorService spyExecutor(TrafficSpyProperties props) {
	    ...
	    return Executors.newFixedThreadPool(props.getWorkingthread(), new java.util.concurrent.ThreadFactory() {
	...
	public FilterRegistrationBean<TrafficSpyFilter> trafficSpyFilter(StorageManager storageManager,
		...
		TrafficSpyFilter filter = new TrafficSpyFilter(storageManager, props.getMaxBodySize(), props.isMaskSensitive(),props);
